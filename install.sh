...
readonly REPO_URL="https://github.com/erffy-dots/rofi.git"
...
echo "Downloading Rofi configuration files from GitHub..."

# Handle existing configuration
if [ -d "$CONFIG_DIR" ]; then
    echo "Existing Rofi configuration detected at '$CONFIG_DIR'."
...
echo "You may need to install additional dependencies for Rofi."
echo "Refer to the Rofi documentation for more information."
